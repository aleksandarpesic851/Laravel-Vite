        ...
        <div class="relative min-h-screen selection:bg-red-500 selection:text-black bg-contain bg-no-repeat"
            ...
            <div class="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="pt-24 pr-20 lg:pr-20 sm:pr-0 h-16 text-right">
                    <span class="inline-flex items-center px-3 text-3xl sm:text-2xl pb-1 font-bold  dark:text-black focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">
                        Boxers
                    </span>
                    <span class="inline-flex items-center px-3 text-3xl sm:text-2xl pb-1 font-bold  dark:text-black focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">
                        Events
                    ...
                    @else
                        <a href="{{ route('register') }}" class="font-semibold inline-flex items-center px-3 text-3xl sm:text-2xl pb-1 text-red focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out" style="color:red;">Join Now</a>
